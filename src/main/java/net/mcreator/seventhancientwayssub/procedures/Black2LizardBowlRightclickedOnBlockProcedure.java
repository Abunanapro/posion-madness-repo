...
public class Black2LizardBowlRightclickedOnBlockProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z, Entity entity) {
		...
		if (world instanceof ServerLevel _level) {
			Entity entityToSpawn = PoisonMadnessModEntities.LIZARD_BLACK_2.get().spawn(_level, BlockPos.containing(x, y + 1, z), MobSpawnType.MOB_SUMMONED);
