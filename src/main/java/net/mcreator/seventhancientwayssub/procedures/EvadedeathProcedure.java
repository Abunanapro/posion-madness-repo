...
public class EvadedeathProcedure {
	@SubscribeEvent
	...
	private static void execute(@Nullable Event event, LevelAccessor world, double x, double y, double z, Entity entity, double amount) {
		if (entity == null)
			return;
		if (amount > (entity instanceof LivingEntity _livEnt ? _livEnt.getHealth() : -1) && entity instanceof LivingEntity _livEnt1 && _livEnt1.hasEffect(PoisonMadnessModMobEffects.REANIMATING_TOXIN.get())) {
