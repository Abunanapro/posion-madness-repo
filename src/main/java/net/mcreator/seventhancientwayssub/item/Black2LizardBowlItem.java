...
public class Black2LizardBowlItem extends Item {
	public Black2LizardBowlItem() {
	...
	public InteractionResult useOn(UseOnContext context) {
		super.useOn(context);
		Black2LizardBowlRightclickedOnBlockProcedure.execute(context.getLevel(), context.getClickedPos().getX(), context.getClickedPos().getY(), context.getClickedPos().getZ(), context.getPlayer());
