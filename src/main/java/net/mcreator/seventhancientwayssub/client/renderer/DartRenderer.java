...
public class DartRenderer extends EntityRenderer<DartEntity> {
	private static final ResourceLocation texture = new ResourceLocation("poison_madness:textures/entities/dart3.png");
	...
	@Override
	public void render(DartEntity entityIn, float entityYaw, float partialTicks, PoseStack poseStack, MultiBufferSource bufferIn, int packedLightIn) {
