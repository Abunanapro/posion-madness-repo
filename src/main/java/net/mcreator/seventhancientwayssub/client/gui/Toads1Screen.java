...
import net.mcreator.seventhancientwayssub.network.Toads1ButtonMessage;
...
public class Toads1Screen extends AbstractContainerScreen<Toads1Menu> {
	private final static HashMap<String, Object> guistate = Toads1Menu.guistate;
	...
	public Toads1Screen(Toads1Menu container, Inventory inventory, Component text) {
	...
	private static final ResourceLocation texture = new ResourceLocation("poison_madness:textures/screens/toads_1.png");
	...
	protected void renderBg(GuiGraphics guiGraphics, float partialTicks, int gx, int gy) {
		...
		guiGraphics.blit(new ResourceLocation("poison_madness:textures/screens/toads1.png"), this.leftPos + -59, this.topPos + -4, 0, 0, 292, 180, 292, 180);
	...
	public void init() {
		...
		imagebutton_leftnewback = new ImageButton(this.leftPos + -86, this.topPos + -4, 32, 32, 0, 0, 32, new ResourceLocation("poison_madness:textures/screens/atlas/imagebutton_leftnewback.png"), 32, 64, e -> {
			if (true) {
				PoisonMadnessMod.PACKET_HANDLER.sendToServer(new Toads1ButtonMessage(0, x, y, z));
				Toads1ButtonMessage.handleButtonAction(entity, 0, x, y, z);
			}
		});
		...
		imagebutton_rightnewnext = new ImageButton(this.leftPos + 229, this.topPos + 68, 32, 32, 0, 0, 32, new ResourceLocation("poison_madness:textures/screens/atlas/imagebutton_rightnewnext.png"), 32, 64, e -> {
			if (true) {
				PoisonMadnessMod.PACKET_HANDLER.sendToServer(new Toads1ButtonMessage(1, x, y, z));
				Toads1ButtonMessage.handleButtonAction(entity, 1, x, y, z);
			}
		});
