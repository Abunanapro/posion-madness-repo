...
import net.mcreator.seventhancientwayssub.network.Frog6ButtonMessage;
...
public class Frog6Screen extends AbstractContainerScreen<Frog6Menu> {
	private final static HashMap<String, Object> guistate = Frog6Menu.guistate;
	...
	public Frog6Screen(Frog6Menu container, Inventory inventory, Component text) {
	...
	private static final ResourceLocation texture = new ResourceLocation("poison_madness:textures/screens/frog_6.png");
	...
	protected void renderBg(GuiGraphics guiGraphics, float partialTicks, int gx, int gy) {
		...
		guiGraphics.blit(new ResourceLocation("poison_madness:textures/screens/frogpage6.png"), this.leftPos + -59, this.topPos + -4, 0, 0, 292, 180, 292, 180);
	...
	public void init() {
		...
		imagebutton_leftnewback = new ImageButton(this.leftPos + -86, this.topPos + -4, 32, 32, 0, 0, 32, new ResourceLocation("poison_madness:textures/screens/atlas/imagebutton_leftnewback.png"), 32, 64, e -> {
			if (true) {
				PoisonMadnessMod.PACKET_HANDLER.sendToServer(new Frog6ButtonMessage(0, x, y, z));
				Frog6ButtonMessage.handleButtonAction(entity, 0, x, y, z);
			}
		});
		...
		imagebutton_leftnewback1 = new ImageButton(this.leftPos + 229, this.topPos + 68, 32, 32, 0, 0, 32, new ResourceLocation("poison_madness:textures/screens/atlas/imagebutton_leftnewback1.png"), 32, 64, e -> {
			if (true) {
				PoisonMadnessMod.PACKET_HANDLER.sendToServer(new Frog6ButtonMessage(1, x, y, z));
				Frog6ButtonMessage.handleButtonAction(entity, 1, x, y, z);
			}
		});
		...
		imagebutton_leftnewback2 = new ImageButton(this.leftPos + -86, this.topPos + 68, 32, 32, 0, 0, 32, new ResourceLocation("poison_madness:textures/screens/atlas/imagebutton_leftnewback2.png"), 32, 64, e -> {
			if (true) {
				PoisonMadnessMod.PACKET_HANDLER.sendToServer(new Frog6ButtonMessage(2, x, y, z));
				Frog6ButtonMessage.handleButtonAction(entity, 2, x, y, z);
			}
		});
