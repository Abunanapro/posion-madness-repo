...
import net.mcreator.seventhancientwayssub.network.Frog7ButtonMessage;
...
public class Frog7Screen extends AbstractContainerScreen<Frog7Menu> {
	private final static HashMap<String, Object> guistate = Frog7Menu.guistate;
	...
	public Frog7Screen(Frog7Menu container, Inventory inventory, Component text) {
	...
	private static final ResourceLocation texture = new ResourceLocation("poison_madness:textures/screens/frog_7.png");
	...
	protected void renderBg(GuiGraphics guiGraphics, float partialTicks, int gx, int gy) {
		...
		guiGraphics.blit(new ResourceLocation("poison_madness:textures/screens/pagefrog7.png"), this.leftPos + -59, this.topPos + -4, 0, 0, 292, 180, 292, 180);
	...
	public void init() {
		...
		imagebutton_leftnewback = new ImageButton(this.leftPos + -86, this.topPos + -4, 32, 32, 0, 0, 32, new ResourceLocation("poison_madness:textures/screens/atlas/imagebutton_leftnewback.png"), 32, 64, e -> {
			if (true) {
				PoisonMadnessMod.PACKET_HANDLER.sendToServer(new Frog7ButtonMessage(0, x, y, z));
				Frog7ButtonMessage.handleButtonAction(entity, 0, x, y, z);
			}
		});
		...
		imagebutton_leftnewback2 = new ImageButton(this.leftPos + -86, this.topPos + 68, 32, 32, 0, 0, 32, new ResourceLocation("poison_madness:textures/screens/atlas/imagebutton_leftnewback2.png"), 32, 64, e -> {
			if (true) {
				PoisonMadnessMod.PACKET_HANDLER.sendToServer(new Frog7ButtonMessage(1, x, y, z));
				Frog7ButtonMessage.handleButtonAction(entity, 1, x, y, z);
			}
		});
